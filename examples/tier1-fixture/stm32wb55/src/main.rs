...
//! STM32WB55 Tier-1 fixture firmware (Cortex-M4F, thumbv7em-none-eabi).
//!
//! Validates the simulator's chip model peripheral-by-peripheral with RAW
//! REGISTER accesses against the peripherals wired by
//! `configs/chips/stm32wb55.yaml`, reporting one line per peripheral class
...
/// adc: ADC1 (stm32l4), clock-gated on RCC_AHB2ENR.ADCEN (bit 13). Gated the CR
/// reads 0. After ungating + power-up (clear DEEPPWD, ADVREGEN, ADEN ->
